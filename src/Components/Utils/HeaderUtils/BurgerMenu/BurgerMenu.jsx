...
function BurgerMenu({ close }) {
  ...
  return (
    <div className="-mr-2 flex lg:hidden mt-[0.375rem] relative">
      <button onClick={() => Context.setIsOpen((prev) => !prev)} type="button" className={`${animation} bg-transparent -mt-[0.375rem] flex-center p-2 rounded-md text-black transition-all duration-300`} aria-controls="mobile-menu" aria-expanded="false">
