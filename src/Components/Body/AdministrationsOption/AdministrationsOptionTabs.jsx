...
function AdministrationsOptionTabs() {
  return (
    <Tabs className="w-full flex-center max-md:flex-col-reverse gap-4 mt-10">
      <div className="max-md:w-full md:w-[49%] lg:w-[55%] flex-center relative">
        ...
        <MouseParallaxContainer containerStyle={{ overflow: "visible" }} resetOnLeave={true} useWindowMouseEvents={true} globalFactorX={0.1} globalFactorY={0.1} className="absolute h-full min-h-[27.1875rem] w-full max-lg:hidden">
          ...
          <MouseParallaxChild className="absolute bottom-[10%] right-[70%] z-20 bg-gradient-to-b from-[#FDE190] to-[#FEC93D] w-[1.125rem] h-[1.125rem] circle" inverted={true} />
          <MouseParallaxChild className="absolute bottom-12 right-[10%] z-20 bg-gradient-to-b from-[#4E97FD] to-[#77CCFD] w-[1.625rem] h-[1.625rem] circle" inverted={true} />
          <MouseParallaxChild className="absolute bg-gradient-to-b z-20 left-[25%] top-8 from-[#ABE54B] to-[#5EA82C] w-[1.125rem] h-[1.125rem] circle" />
      ...
      <div className="max-md:w-full md:w-[49%] lg:w-[44%] max-w-[30rem]">
